// src/shared/components/SaleEntryFields.jsx
    ...
    <div className="flex-1">
      ...
      <div className="relative">
        ...
        <Input
          type="number"
          step="0.01"
          className={`pl-6 py-1 text-sm h-8 ${
            isOverridden && !isEdit ? "bg-yellow-50 border-yellow-400 text-yellow-800" : ""
          }`}
          placeholder="0.00"
          value={royaltyValue || ""}
...
export const AuthorRoyaltiesSection = ({
  book,
  authorRoyalties,
  authorPaid,
  overrides,
